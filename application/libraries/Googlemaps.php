...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyANNc1-MZMq0duMkVgXAUfNfFHEOi78NeQ';
	// var $apiKey						= 'AIzaSyDDconRsppCpoclh2bQDogd0TQywPOLmg4';					// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
