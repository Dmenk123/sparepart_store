          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <div class="col-xs-12">
                  <h4 style="text-align: center;"><strong>Laporan Penerimaan Produk</strong></h4>
                </div>
                <div class="col-xs-12">
                  ...
                  <table id="laporanStokProduk" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th style="width: 30px; text-align: center;">ID Masuk</th>
                        <th style="width: 40px; text-align: center;">Tgl Masuk</th>
                        ...
                        <th style="width: 80px; text-align: center;">Tgl Order</th>
                      </tr>
                    </thead>
                    <tbody>
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url("laporan_penerimaan/cetak_laporan_penerimaan/".$tglAwal."/".$tglAkhir.""); ?>
