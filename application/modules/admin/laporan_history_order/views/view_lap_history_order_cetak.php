...
<body>
  <div class="container"> 
    ...
    <table class="tbl-header">
      <tr>
        <td align="center">
          <h2 style="text-align: center;"><strong>Laporan Riwayat Permintaan Produk - Dmenk Clothing E-shop</strong></h2>
    ...
    <table id="tbl_content" class="table table-bordered table-hover" cellspacing="0" width="100%" border="2">
      <thead>
        <tr>
          ...
          <th style="width: 30px;">ID Order</th>
          ...
          <th style="width: 60px;">Harga Total</th>
        </tr>
      </thead>
      <tbody>
      <?php $no = 1; ?>
      <?php foreach ($hasil_data as $val ) : ?>
        <tr>
          ...
          <td><?php echo date("d-m-Y", strtotime($val->tgl_trans_order)); ?></td>
