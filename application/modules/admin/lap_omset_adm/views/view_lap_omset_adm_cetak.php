...
<body>
  <div class="container"> 
    ...
    <table class="tbl-header">
      <tr>
        <td align="center">
          <h2 style="text-align: center;"><strong>Laporan Pendapatan OnPets E-Marketplace</strong></h2>
      ...
      <?php if (count($hasil_data) != 0): ?>
        ...
        <?php foreach ($hasil_data as $val ) : ?>
          ...
          <tr>
            ...
            <td>
              <div class="pull-right">Rp. <?php echo number_format($val->nominal,2,",","."); ?></div>
            </td>
            <td>
              <div class="pull-right">Rp. <?php echo number_format($val->bea_layanan,2,",","."); ?></div>
            </td>
            <td>
              <div class="pull-right">Rp. <?php echo number_format($val->bea_vendor,2,",","."); ?></div>
            </td>
            <td>
        ...
        <tr>
          ...
          <td>
            <div class="pull-right">Rp. <?= number_format($tot_nominal,2,",","."); ?></div>
          </td>
          <td>
            <div class="pull-right">Rp. <?= number_format($tot_layanan,2,",","."); ?></div>
          </td>
          <td>
            <div class="pull-right">Rp. <?= number_format($tot_vendor,2,",","."); ?></div>
          </td>
          <td>
            <div class="pull-right">Rp. <?= number_format($tot_nett,2,",","."); ?></div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="pull-right"><strong>Rp. <?= number_format($tot_nett,2,",","."); ?></strong></div>
          </td>
        </tr> 
      <?php endif ?>
      </tbody>
    ...
    <table class="tbl-footer">
        ...
        <tr>
          <td align="right">
            <p style="text-align: right;" class="foot-right">( <?php echo $this->session->userdata('fname_user').' '.$this->session->userdata('lname_user');?> ) </p>      
          </td>
        </tr>
    </table>
  </div>          
