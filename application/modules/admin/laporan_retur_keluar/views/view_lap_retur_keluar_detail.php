    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Retur Produk</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <div class="col-xs-12">
                  <h4 style="text-align: center;"><strong>Laporan Retur Produk</strong></h4>
                </div>
                <div class="col-xs-12">
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url("laporan_retur_keluar/cetak_laporan_retur_keluar/".$tglAwal."/".$tglAkhir.""); ?>
                    <?php echo '<a class="btn btn-sm btn-success" href="'.$link_print.'" target="_blank" title="Print Laporan Retur" id="btn_print_laporan_order"><i class="glyphicon glyphicon-print"></i> Cetak</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
