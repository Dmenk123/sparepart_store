  ...
  <div class="container">
    <?php foreach ($hasil_header as $val ) : ?>
      ...
      <table class="tbl-header">
        <tr>
          ...
          <td align="right">
              <p style="text-align: right; font-size: 14px" class="head-left"><strong>Surabaya, <?php echo $val->tgl_trans_order; ?></strong></p>
          </td>
        </tr>
        <tr> 
        ...
        <tr class="inner-head-left"> 
          <td align="left" class="inner-head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="inner-head-left">Dengan hormat, kami bermaksud melakukan pembelian barang kepada PT/Toko/Sdr : <strong><?php echo $val->nama_supplier; ?></strong> sebagaimana yang telah disetujui sesuai dengan harga yang ditawarkan sebelumnya, Berikut barang-barang yang akan kami pesan :</p>
          </td>
        </tr>    
      </table>
    <?php endforeach ?>
    ...
    <table class="tbl-content-footer">
        <tr class="content-footer-left"> 
          <td align="left" class="content-footer-left" colspan="5">
            <p style="text-align: left; font-size: 12px" class="content-footer-left">Dimohon agar lembar putih surat ini disimpan lalu lembar kuning dan hijau dikembalikan saat kru kami ketoko anda, atau apabila barang dikirim ke toko kami mohon disertakan copy surat ini yang telah dikirimkan sebelumnya. apabila ada kendala mohon hubungi <strong>telp/WA : 0817-0340-3473</strong> atau <strong>email : rizkiyuandaa@gmail.com</strong>, Terima kasih.</p>
          </td>
        </tr>  
      </table>
    <table class="tbl-footer">
        <tr>
          ...
          <td align="right">
            <p style="text-align: right;" class="foot-right"><strong>Supplier</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          </td>
        </tr>
        <tr>
          <td align="left">
